...
const startIpValidation = useValidation({
  ...
  rules: [{ message: t('tools.ipv4-range-expander.invalidIpv4Address'), validator: ip => isValidIpv4({ ip }) }],
});
  ...
  <div>
    <div mb-4 flex gap-4>
      <c-input-text
        ...
        :label="t('tools.ipv4-range-expander.startAddressLabel')"
      ...
      <c-input-text
        ...
        :label="t('tools.ipv4-range-expander.endAddressLabel')"
...
&nbsp;
    ...
    >
      <div my-3 op-70>
        {{ t('tools.ipv4-range-expander.invalidCombinationDescription') }}
        {{ t('tools.ipv4-range-expander.invalidCombinationHint') }}
      </div>
