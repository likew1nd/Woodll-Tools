...
const { copy: copySVG } = useCopy({ source: svgString, text: t('tools.svg-placeholder-generator.svgCopied') });
const { copy: copyBase64 } = useCopy({ source: base64, text: t('tools.svg-placeholder-generator.base64Copied') });
...
<template>
  <div>
    <n-form label-placement="left" label-width="100">
      ...
      <n-form-item :label="$t('tools.svg-placeholder-generator.useExactSizeLabel')" label-placement="left">
        <n-switch v-model:value="useExactSize" />
      </n-form-item>
    </n-form>

    <n-form-item :label="$t('tools.svg-placeholder-generator.svgElementLabel')">
      <TextareaCopyable :value="svgString" copy-placement="none" />
    </n-form-item>
    <n-form-item :label="$t('tools.svg-placeholder-generator.svgBase64Label')">
