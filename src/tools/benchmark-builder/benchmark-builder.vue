...
const suites = useStorage('benchmark-builder:suites', [
  { title: t('tools.benchmark-builder.suiteTitle', { index: 1 }), data: [5, 10] },
  { title: t('tools.benchmark-builder.suiteTitle', { index: 2 }), data: [8, 12] },
]);
    ...
    <div mb-5 flex flex-1 flex-nowrap justify-center gap-12px>
      <div v-for="(suite, index) of suites" :key="index">
        ...
        <div flex justify-center>
          ...
          <c-button
            variant="text"
            @click="suites.splice(index + 1, 0, { data: [0], title: t('tools.benchmark-builder.suiteTitle', { index: suites.length + 1 }) })"
          >
    ...
    <div style="max-width: 600px; margin: 0 auto">
      <div mx-auto max-w-sm flex justify-center gap-3>
        <c-input-text
          ...
          :label="t('tools.benchmark-builder.unitLabel')"
          label-position="left"
          mb-4
        />
        ...
        <c-button
          @click="
            suites = [
              { title: t('tools.benchmark-builder.suiteTitle', { index: 1 }), data: [] },
              { title: t('tools.benchmark-builder.suiteTitle', { index: 2 }), data: [] },
            ]
          "
        >
